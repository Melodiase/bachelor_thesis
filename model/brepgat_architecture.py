...
class BRepGAT(nn.Module):
    def __init__(self, node_in_dim, edge_in_dim, hidden_dim, num_classes, dropout=0.5, heads=4):
        ...
        self.gat4 = GATConv(hidden_dim * heads, hidden_dim, heads=1, concat=False, edge_dim=edge_in_dim)  # Final layer (no ReLU)
    ...
    def forward(self, data):
        ...
        x = self.gat4(x, edge_index, edge_attr)  # No activation after final GAT
